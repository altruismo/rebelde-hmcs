            ...
            <main class="flex-1 lg:px-48 px-6 py-6 bg-heaven dark:bg-dark-shade">
                ...
                <div class="flex items-center w-full mx-auto">   
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="voice-search" class="bg-milk border border-dim text-secondary text-sm rounded-lg focus:ring-primo focus:border-clear block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('dashboard.searchbar_placeholder') }}" required />
                        <button type="button" class="absolute inset-y-0 end-0 flex items-center pe-3 hidden">
                            <svg class="w-4 h-4 text-dim dark:text-gray-400 hover:text-primo dark:hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7v3a5.006 5.006 0 0 1-5 5H6a5.006 5.006 0 0 1-5-5V7m7 9v3m-3 0h6M7 1h2a3 3 0 0 1 3 3v5a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V4a3 3 0 0 1 3-3Z"/>
                            </svg>
                        </button>
                    </div>
                    <button type="submit" class="inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-secondary rounded-lg border border-secondary hover:bg-deep focus:ring-1 focus:outline-none focus:ring-primo dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
