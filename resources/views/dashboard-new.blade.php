<x-app-layout>
  <div class="antialiased bg-gray-50 dark:bg-gray-900">
    <nav class="bg-heaven border-b border-dim text-secondary px-4 fixed left-2 right-0 top-0 z-50">
    ...
    <aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-dim md:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidenav" id="drawer-navigation">
