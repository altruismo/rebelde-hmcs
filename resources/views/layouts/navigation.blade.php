    ...
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <button
                ...
                class="p-2 mr-1 ml-3 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-dark-dim dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                ...
                <div>
                    <a
                        ...
                        <div class="pl-3 w-full">
                            <div
                                class="text-gray-500 font-normal text-sm mb-1.5 dark:text-dark-dim">
                                New message from
            ...
            <button
                ...
                class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-dark-dim dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                <span class="sr-only">View notifications</span>
                <!-- Icon -->
                <svg
                    class="w-6 h-6"
