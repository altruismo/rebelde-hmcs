<div class="h-96 rounded-lg shadow-md">
    ...
    <div class="p-4 pt-1 dark:bg-dark-deep">
        <p class="text-sm mb-4 font-normal text-gray-500 dark:text-gray-400">Let us know you made a payment.<span class="text-xs"> This fields * are mandatory.</span></p>        
        <form>
            <div class="grid gap-6 mb-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <div id="tooltip-notify-websiteurl" role="tooltip" class="absolute z-30 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-dark-brown">
                ...
                <div>
                    ...
                    <div id="tooltip-notify-phonenumber" role="tooltip" class="absolute z-30 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-dark-brown">
                ...
                <div>
                    ...
                    <div id="tooltip-notify-email" role="tooltip" class="absolute z-30 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-dark-brown">
